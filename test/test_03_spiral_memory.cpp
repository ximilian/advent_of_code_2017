...
TEST(SpiralMemoryTest, solve_test) {
  ...
  std::cout << SpiralMemory::solve("2") << std::endl;
  std::cout << SpiralMemory::solve("3") << std::endl;
  std::cout << SpiralMemory::solve("4") << std::endl;
  std::cout << SpiralMemory::solve("5") << std::endl;
  std::cout << SpiralMemory::solve("6") << std::endl;
